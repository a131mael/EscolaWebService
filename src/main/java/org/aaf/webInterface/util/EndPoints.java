...
public class EndPoints {
	...
	public static final String SCRAPS = new StringBuilder(urlBase).append("/EscolaWebService/rest/recados").toString();
	
	public static final String GRADE = new StringBuilder(urlBase).append("/EscolaWebService/rest/grades").toString();
}
